...
function handleScrollFunc(page: IndexPage) {
  return () => {
    page.setState({
      headerFixed: (window.pageYOffset > window.screenY),
    });
  }
}
  ...
  render() {
    return (
      <div className="min-h-screen">
        <header className="w-full z-40 fixed top-0 bg-white">
          <div className="h-20 flex items-center border-b border-gray-300">
            <div className="flex ml-4 mr-5 w-full justify-between">
              ...
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>
              </div>
            </div>
          </div>
        </header>
